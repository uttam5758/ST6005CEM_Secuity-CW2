    ...
    <div className="text-center">
      ...
      <p className="contact-us-methods">
        ...
        <ul className="contact-us-list">
          <li>
            <a href="uttamsapkota.danger@gmail.com" className="contact-us-link">Email: uttamsapkota.danger@gmail.com</a>
          </li>
          <li>
            <a href="tel:9815524624" className="contact-us-link">Phone: 9815524624</a>
          </li>
          <li>
            <a href="#" className="contact-us-link">Address: Lokhanthali, Bhaktapur, Nepal</a>
          </li>
        </ul>
      </p>
